...
func LoadConfig(fileName string){
    ...
    log.Println(config_G.TopoName)
    log.Println(config_G.RequestFile)
    log.Println(config_G.SchedulerName)
    log.Println(config_G.LatencyPara)
    log.Println(config_G.MemCap)
    log.Println(config_G.NodeNum)
    log.Println(config_G.Beta)
    log.Println(config_G.SlotNum)
    log.Println(config_G.ReduFactor)
    log.Println(config_G.Token)
